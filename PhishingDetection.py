...
'''
train_set_x: shape (8843, 30)
train_set_y: shape (8843,)
test_set_x: shape (2211, 30)
test_set_y: shape (2211,)
'''
def sigmoid(z):
    """
...
# NN_model
def nn_model(X, Y, n_h, learning_rate, num_iterations = 2, print_cost=False):
...
parameters = nn_model(df_x, df_y, 4, 1.2 , num_iterations = 2, print_cost=True)
