...
'''
layer_dims = [30, 15, 5, 1]

parameters = initialize_parameters_deep(layer_dims)


AL, caches = L_model_forward(df_x, parameters)
print("AL = " + str(AL))
print("Length of caches list = " + str(len(caches)))



cost = compute_cost(AL, df_y)
print("cost = " + str(cost))

grads = L_model_backward(AL, df_y, caches)
parameters = update_parameters(parameters, grads, 0.01)
print(parameters)
'''

def DNNepoch(no_of_iter, layer_dims):
